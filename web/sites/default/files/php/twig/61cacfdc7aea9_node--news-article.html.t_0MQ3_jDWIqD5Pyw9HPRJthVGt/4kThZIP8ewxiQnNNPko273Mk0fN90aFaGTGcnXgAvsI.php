...
<article";
  ...
  ";
      ...
      <div";
            // line 99
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["author_attributes"] ?? null), "addClass", [0 => "node__submitted"], "method", false, false, true, 99), 99, $this->source), "html", null, true);
            echo ">
        ";
            // line 100
  ...
  <div";
        // line 106
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", [0 => "node__content"], "method", false, false, true, 106), 106, $this->source), "html", null, true);
        echo ">
  <span class=\"time-elapsed\"> ";
        // line 107
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar("Last Updated: ");
        echo " ";
        $context["date"] = twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "createdtime", [], "any", false, false, true, 107), 107, $this->source), "M d, Y");
        echo " ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar("IST");
        echo " </span>
  <h2 class=\"news_title\"> ";
        // line 108
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["news_title"] ?? null), 108, $this->source), "html", null, true);
        echo " </h2>
    ";
        // line 109
...
";
    ...
    {
        return array (  126 => 109,  122 => 108,  114 => 107,  110 => 106,  107 => 105,  99 => 101,  97 => 100,  93 => 99,  89 => 98,  86 => 97,  84 => 96,  78 => 94,  70 => 91,  65 => 90,  63 => 89,  59 => 88,  54 => 86,  50 => 85,  48 => 82,  47 => 81,  46 => 80,  45 => 79,  44 => 78,  43 => 77,  42 => 75,  39 => 73,);
    }
...
<article{{ attributes.addClass(classes) }}>
  ...
  <span class=\"time-elapsed\"> {{'Last Updated: '}} {% set date = node.createdtime|date('M d, Y') %} {{'IST'}} </span>
...
", "themes/icecream/templates/node--news-article.html.twig", "/var/www/html/republicnews/web/themes/icecream/templates/node--news-article.html.twig");
    ...
    {
        static $tags = array("set" => 75, "if" => 89, "trans" => 100);
        static $filters = array("clean_class" => 77, "escape" => 85, "date" => 107);
