...
($context["current_user_is_owner"] ?? null)) ? ("current-user-is-owner") : (""))];
        // line 85
        $context["date"] = twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "createdtime", [], "any", false, false, true, 85), 85, $this->source), "M d, Y, H:i");
        // line 86
        echo "
";
        // line 87
...
<article";
  ...
  ";
      ...
      <div";
            // line 101
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["author_attributes"] ?? null), "addClass", [0 => "node__submitted"], "method", false, false, true, 101), 101, $this->source), "html", null, true);
            echo ">
        ";
            // line 102
  ...
  <div";
        // line 108
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", [0 => "node__content"], "method", false, false, true, 108), 108, $this->source), "html", null, true);
        echo ">
  <span class=\"time-elapsed\"> ";
        // line 109
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar("Last Updated: ");
        echo " ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["date"] ?? null), 109, $this->source), "html", null, true);
        echo " ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar("IST");
        echo " </span>
  <h2 class=\"news_title\"> ";
        // line 110
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["news_title"] ?? null), 110, $this->source), "html", null, true);
        echo " </h2>
    ";
        // line 111
...
";
    ...
    {
        return array (  131 => 111,  127 => 110,  119 => 109,  115 => 108,  112 => 107,  104 => 103,  102 => 102,  98 => 101,  94 => 100,  91 => 99,  89 => 98,  83 => 96,  75 => 93,  70 => 92,  68 => 91,  64 => 90,  59 => 88,  55 => 87,  52 => 86,  50 => 85,  48 => 82,  47 => 81,  46 => 80,  45 => 79,  44 => 78,  43 => 77,  42 => 75,  39 => 73,);
    }
...
%}
{% set date = node.createdtime|date('M d, Y, H:i') %}
...
", "themes/icecream/templates/node--news-article.html.twig", "/var/www/html/republicnews/web/themes/icecream/templates/node--news-article.html.twig");
    ...
    {
        static $tags = array("set" => 75, "if" => 91, "trans" => 102);
        static $filters = array("clean_class" => 77, "date" => 85, "escape" => 87);
        static $functions = array("attach_library" => 87);
