...
($context["current_user_is_owner"] ?? null)) ? ("current-user-is-owner") : (""))];
        // line 85
        $context["date"] = twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "createdtime", [], "any", false, false, true, 85), 85, $this->source), "j\th F, Y, H:i");
        // line 86
        echo "
";
        // line 88
...
%}
{% set date = node.createdtime|date('j\\th F, Y, H:i') %}
