...
<article";
  ...
  <span class=\"time-elapsed\"> ";
        ...
        echo " ";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["new_date"] ?? null), 107, $this->source), "html", null, true);
        echo " ";
...
<article{{ attributes.addClass(classes) }}>
  ...
  <span class=\"time-elapsed\"> {{'Last Updated: '}} {{new_date}} {{'IST'}} </span>
