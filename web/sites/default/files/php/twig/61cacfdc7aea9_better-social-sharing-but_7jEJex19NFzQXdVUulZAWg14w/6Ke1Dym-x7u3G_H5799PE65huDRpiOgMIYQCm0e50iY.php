...
class __TwigTemplate_894f33af37e16cdb4d29185904c9264d8d8094fbda264b521efacbc5d51cf325 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"social-sharing-buttons\">
    ...
    {% if items.services.linkedin %}
        <a href=\"https://www.linkedin.com/sharing/share-offsite/?url={{ items.page_url }}\" target=\"_blank\" title=\"{{ 'Share to'|t }} Linkedin\" aria-label=\"{{ 'Share to'|t }} Linkedin\" class=\"social-sharing-buttons__button\" rel=\"noopener\">
            <svg {{ width }} {{ height }} {{ radius }}>
...
", "modules/better_social_sharing_buttons/templates/better-social-sharing-buttons.html.twig", "/var/www/html/republicnews/web/modules/better_social_sharing_buttons/templates/better-social-sharing-buttons.html.twig");
    }
